...
var DISPARO = preload("res://disparoEnemyM.tscn")
var DISPAROIZQ = preload("res://disparoIzqEnemyM.tscn")
...
func _on_Area2D_area_entered(area):
	...
	if VIDA_ENEMY == 0:
		queue_free()
		get_tree().change_scene("res://gameWinner.tscn")
	pass
####################################################
...
#		$AnimatedSprite/RayAtack.set_enabled(true)
	if !_next_to_wall_atack():
		if _next_to_right_wall() or _next_to_left_wall() or !_floor_detection():
			...
			print("Esta atacando? MASTER......",_next_to_wall_atack())
...
func disparar():
	if tiempoTranscurridoDisparo >= tiempoPorCadaDisparo:
		...
		disparo.position = position + Vector2 ( 200 , 80 )
